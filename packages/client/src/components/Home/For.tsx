...
const For: React.FC = () => {
  const NET42for = [
    ...
    { title: "Global Community", description: "NET42 unites a global community, magnifying our positive impact together." },
  ];
      ...
      <Container>
        <div className="text-center mb-[60px]">
          ...
          <div className="text-[20px] max-w-[1040px] mx-auto">
            At NET42, we believe in the power of community and the importance of our planet. Every marathon is a step towards a better world
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {NET42for.map((item, index) => (
