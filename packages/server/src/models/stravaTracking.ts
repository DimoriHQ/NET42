...
// use https://www.npmjs.com/package/strava-v3 instead

// export const authorize = (req: any) => {
//   const url = encodeURIComponent(req.protocol + "//" + req.host + "/v1/home");
//   const strava_authorize = `${process.env.STRAVA_AUTH_LINK!}?client_id=${process.env.STRAVA_CLIENT_ID!}&redirect_uri=${url}&approval_prompt=auto&scope=read%2Cactivity%3Aread&response_type=code`;
