...
contract RunningNFT is ERC721URIStorage, Ownable {
    ...
    function init() public{
        createAchievement(5, 300, "thaydoichophuhop","BM2023");
        createAchievement(10, 300, "thaydoichophuhop","BM2023");
        createAchievement(21, 300, "thaydoichophuhop","BM2023");
        createAchievement(42, 300, "QmWhfxXWkHAzMZnF2JJv8DFH95sMFGvjEGCSAPcrr9whec","BM2023");
        createAchievement(1, 800, "thaydoichophuhop","BM2023");
    }
    function addCampaign() public onlyOwner{}
